...
ADMINS = (
	...
	('Kevin Hughes',  'kevinhughes27@gmail.com'),
)
...
if PRODUCTION:
    ...
    MATRIX_FILE=os.path.join(ROOT_PATH, "static/media/feature_matrix.csv")
    DEBUG = True
...
SECRET_KEY = '8nwf9^t)r5qd%cuf^%8lr+n!79!@91w)&amp;ntk3q7&amp;m9az4&amp;9_uj'
